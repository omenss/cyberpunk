...
import com.cyberpunk.netty.support.*;
 ...
 * @version 1.0
 */
public class SimpleEndpointServer {
    ...
    private final Map<String, MethodMapping> pathMethodMappingMap = new HashMap<>(256);

    private final ServerEndpointConfig config;

    private Set<WsPathMatcher> pathMatchers = new HashSet<>();

    private static final InternalLogger logger = InternalLoggerFactory.getInstance(SimpleEndpointServer.class);

    public SimpleEndpointServer(MethodMapping methodMapping, ServerEndpointConfig config, String path) {
    ...
    public void addPathPojoMethodMapping(String path, MethodMapping methodMapping) {
