...
import com.cyberpunk.netty.utils.SslUtils;
...
public class WebsocketServer {
    ...
    public WebsocketServer(SimpleEndpointServer simpleEndpointServer, ServerEndpointConfig serverEndpointConfig) {
        this.simpleEndpointServer = simpleEndpointServer;
        this.config = serverEndpointConfig;

    }

    public SimpleEndpointServer getSimpleEndpointServer() {
        return simpleEndpointServer;
    }

    public void init() throws InterruptedException, SSLException {
        EventExecutorGroup eventExecutorGroup = null;
        final SslContext sslCtx;
        if (!ObjectUtils.isEmpty(config.getKeyStore())) {
        ...
        bootstrap.group(boss, worker)
                ...
                .childHandler(new ChannelInitializer<NioSocketChannel>() {
                    ...
                    protected void initChannel(NioSocketChannel ch) {
                        ...
                        pipeline.addLast(new HttpServerHandler(simpleEndpointServer, config, finalEventExecutorGroup, corsConfig != null));
                    }
                });
